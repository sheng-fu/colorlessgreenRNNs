...
class Corpus_Sent(object):
    def __init__(self, path):
        self.dictionary = Dictionary(path)
        self.train = sent_tokenize_with_unks(self.dictionary, os.path.join(path, 'train.txt'))
        self.valid = sent_tokenize_with_unks(self.dictionary, os.path.join(path, 'valid.txt'))
        self.test = sent_tokenize_with_unks(self.dictionary, os.path.join(path, 'test.txt'))
...
def sent_tokenize_with_unks(dictionary, path):
